                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12 col-lg-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" value="<?php if (isset($title[0]->painting_title)) {
                            ...
                            <div class="draw-section">
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12 col-lg-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" value="<?php if (isset($tag[0]->tag)) {
                                                                                                    echo $tag[0]->tag;
                                                                                                } ?>" readonly>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12 col-lg-12">
                                            <div class="form-group ">
                                                ...
                                                <?php
                                                 if (!empty($script[0]->script)) {
                                                    $script = explode(",", $script[0]->script);
...
<!-- <a href="<?php// echo base_url() ?>assign_artist/<?php// echo  $this->uri->segment(2); ?>" class="btn btn-primary ms-auto"  >Assign to artist</a>  -->
